...
class Main(object):
    ...
    def renomeia_estados_automato(self, automato1, automato2):
        ...
        print('quantidade de estados: ', qtd)
        ...
        #new_automato = Automato(automato1.lista_transicao[1].nome)
...
aut = Automato('a')
aut.add_transicao('q1','b','q2')

aut2 = Automato('d')
aut2.add_transicao('q1','e','q2')


aut.imprimir_automato()
aut2.imprimir_automato()

teste.renomeia_estados_automato(aut,aut2)
